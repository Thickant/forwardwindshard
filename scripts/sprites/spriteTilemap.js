...
define(['game', 'pixi'], function (game, PIXI) {
  ...
  // ** Sprite of a Tilemap
  //*******************************************************************************************************************
  var SpriteTilemap = /*#__PURE__*/function (_PIXI$Sprite) {
    _inherits(SpriteTilemap, _PIXI$Sprite);

    var _super = _createSuper(SpriteTilemap);

    function SpriteTilemap(layer) {
      _classCallCheck(this, SpriteTilemap);

      return _super.call(this, PIXI.Loader.shared.resources['assets/tileLayer' + (layer + 1) + '.png'].texture);
    }

    _createClass(SpriteTilemap, [{
      key: "update",
      value: function update() {// this.updateCamera()
      } // updateVisibillity() {
      ...
      // }
      // updateCamera() {
      //   let index = this.tile.id
      //   let x = (index % 16) * 16
      //   let y = Math.floor(index / 16) * 16
      //   let w = 16
      //   let h = 16
