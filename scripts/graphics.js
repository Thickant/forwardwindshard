...
define(['pixi', 'dataWorld', 'spriteText', 'spriteIcon', 'spriteHealthBar', 'spritePauseHeader', 'spriteLogo', 'spriteTile', 'spriteEntity', 'spriteEntityPNG', 'spriteBackground', 'spriteLoadingBar', 'spriteBrandingIcon', 'spriteTilemap'], function (PIXI, DataWorld, SpriteText, SpriteIcon, SpriteHealthBar, SpritePauseHeader, SpriteLogo, SpriteTile, SpriteEntity, SpriteEntityPNG, SpriteBackground, SpriteLoadingBar, SpriteBrandingIcon, SpriteTilemap) {
  ...
  var Graphics = /*#__PURE__*/function () {
    ...
    _createClass(Graphics, [{
      ...
      value: function addTilemap(x, y) {
        ...
        var sprite = _construct(SpriteTilemap, args);
