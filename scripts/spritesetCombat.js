...
define(['game'], function (game) {
  ...
  var SpritesetCombat = /*#__PURE__*/function () {
    ...
    _createClass(SpritesetCombat, [{
      ...
      key: "setupTilemaps",
      value: function setupTilemaps() {
        for (var i = 0; i < 3; i++) {
          var tilemap = game.graphics.addTilemap(0, 0, i);
          tilemap.visible = game.entities.layerIndex == i;
      ...
      value: function update() {
        this.updateEntities(); //this.updateTiles()
        //this.updateTilemap()
      ...
      value: function dispose() {
        Object.values(this.entities).forEach(function (e) {
          return e.destroy();
        }); //Object.values(this.tiles).forEach(t => t.visible = false)
        ...
        this.tilemaps.forEach(function (t) {
          return t.destroy();
        });
